...
export default function SectionLabel({
  ...
  return (
    ...
    >
      <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-signal/50 bg-ink font-mono text-[11px] text-signal shadow-[0_0_8px_0_rgba(255,122,26,0.25)]">
        {n}
      </span>
